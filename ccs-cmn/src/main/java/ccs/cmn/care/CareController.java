...
@Controller
@RequestMapping(value = "/care/care")
public class CareController {

	private final Logger LOGGER = LoggerFactory.getLogger(CareController.class.getName());
	...
	public String careList(@PathVariable("target_type") String target_type,
	...
	public DataTableInfoVO selectData(@RequestBody Map<String, Object> param, SystemParameter systemParameter){
		...
		List<Map<String, Object>> dataList =  careService.selectCareList(data);
	...
	public AjaxResult save(JsonParameter jsonParameter, SystemParameter systemParameter) {
		try {
			Map<String,Object> param = HashMapUtility.<String,Object>create()
										...
										.add(systemParameter.toMap())
										.toMap();	
			Map<String, Object> data = careService.saveCare(param);
