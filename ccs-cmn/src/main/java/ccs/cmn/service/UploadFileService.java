...
public interface UploadFileService {
	...
	String uploadFiles(HttpServletRequest request, Map<String, Object> systemParameter, String FILE_GRUP, List<Map<String,Object>> filesToDelete) throws Exception;
